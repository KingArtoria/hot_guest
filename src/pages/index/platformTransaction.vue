  ...
  <view>
    <view class="head">
      <view class="head_1" @click="toBack">
        <image class="head_1_1" src="http://39.106.208.234/pic/img_/black_icon_w.png" />
      </view>
      <view class="head_2">平台交易</view>
      <view class="head_3">
        <image class="head_3_1" src="http://39.106.208.234/pic/img_/yiwen_ptjy.png" @click="goTradingRules" />
      </view>
    </view>
    <view class="content">
      <!-- 介绍轮播 -->
      ...
      <view class="content_1">
        <u-input placeholder="请输入交易对方的手机号" fontSize="30rpx" color="#9e9e9e" border="none" v-model="params.to_id" />
      </view>
      <!-- 买卖关系 -->
      <view class="content_2">
        <Title title="买卖关系" />
        <view class="content_2_1">
          <view :class="isBuy ? 'content_2_1_1' : 'content_2_1_2'" @click="changeBuySell(true)">我是付款方</view>
          <view :class="isBuy ? 'content_2_1_2' : 'content_2_1_1'" @click="changeBuySell(false)">我是收款方</view>
        </view>
      </view>
      <!-- 担保内容 -->
      <view class="content_3">
        ...
        <view class="content_3_1">
          <view class="content_3_1_1">
            ...
            <u--input placeholder="请输入内容" border="none" fontSize="28rpx" v-model="content" />
          </view>
          <view class="content_3_1_1">
            <view class="content_3_1_1_1">对方要求：</view>
            <u--input placeholder="请输入内容" border="none" fontSize="28rpx" v-model="request" />
          </view>
          <view class="content_3_1_1">
            <view class="content_3_1_1_1">结算条件：</view>
            <u--input placeholder="请输入内容" border="none" fontSize="28rpx" v-model="condition" />
          </view>
          <view class="content_3_1_1">
            <view class="content_3_1_1_1">其他补充：</view>
            <u--input placeholder="请输入内容" border="none" fontSize="28rpx" v-model="supplement" />
          </view>
        </view>
      </view>
      <!-- 担保金额 -->
      <view class="content_4">
        <Title title="担保金额" />
        <view class="content_4_1">注：担保金不可以作为业务结算资金进行支付</view>
        <view class="content_4_2">
          <view class="content_4_2_1">￥</view>
          <view class="content_4_2_2" />
          <u--input placeholder="请输入金额" border="none" fontSize="30rpx" v-model="params.price" />
        </view>
      </view>
    </view>
    <!-- 提交按钮 -->
...
export default {
  data() {
    return {
      ...
      list: ['http://39.106.208.234/pic/img_/ptjy_hzlc.png', 'http://39.106.208.234/pic/img_/ptjy_banner.png'],
      // 买卖关系
      isBuy: true,
      // 担保交易参数
      params: {},
